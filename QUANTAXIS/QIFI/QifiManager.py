...
class QA_QIFIMANAGER():
    ...
    def __init__(self, account_cookie, mongo_ip=mongo_uri, database='quantaxis', collection='history'):
        self.mongo_uri = mongo_ip
    ...
    def change_database(self, database_name, collection_name):
        ...
        return pymongo.MongoClient(self.mongo_uri).get_database(
...
class QA_QIFISMANAGER():
    ...
    def __init__(self, mongo_ip=mongo_uri, account_cookie='', model='BACKTEST'):
